...
INSERT INTO `actor` (`idCast`, `idMovie`, `role`) VALUES
(1, 4, 'Iron Man'),
(1, 7, 'Star Lord'),
...
INSERT INTO `cast` (`id`, `firstname`, `lastname`, `sex`, `nationality`) VALUES
...
INSERT INTO `director` (`idCast`, `idMovie`) VALUES
(12, 0),
(11, 4),
(12, 5),
(12, 6),
...
--
-- Contenu de la table `frequenting`
--

INSERT INTO `frequenting` (`id`, `year`, `month`, `numbersOfEntries`, `idTheater`) VALUES
...
INSERT INTO `movie` (`id`, `title`, `blackAndWhite`, `releaseDate`, `imageLink`, `nationality`) VALUES
...
--
-- Contenu de la table `movietheater`
--

INSERT INTO `movietheater` (`idMovie`, `idTheater`) VALUES
(4, 1),
(9, 1),
(15, 1),
(5, 2),
...
INSERT INTO `nationality` (`countryCode`, `countryName`) VALUES
('FRA', 'France'),
('GBA', 'Grande Bretagne'),
('USA', 'États-Unis');
...
--
-- Contenu de la table `theater`
--

INSERT INTO `theater` (`id`, `name`, `address`, `postalCode`, `latitude`, `longitude`, `numberOfSeat`, `numberOfRoom`, `artHouse`) VALUES
...
ALTER TABLE `cast`
  ADD PRIMARY KEY (`id`),
  ADD KEY `castNationality` (`nationality`);
...
ALTER TABLE `movie`
  ADD PRIMARY KEY (`id`),
  ADD KEY `movieNationality` (`nationality`);
...
--
-- Index pour la table `movietheater`
--
